...
public class Round {
    ...
    @Column(name = "NUM_OF_GAMES_14_HITS")
    private int numOfGames14Hits;

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "amount", column = @Column(name = "PRICE_OF_14_HITS_AMOUNT")),
            @AttributeOverride(name = "currency", column = @Column(name = "PRICE_OF_14_HITS_CURRENCY"))
    })
    private Price priceOf14Hits;

    @Column(name = "NUM_OF_GAMES_13_HITS")
    private int numOfGames13Hits;

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "amount", column = @Column(name = "PRICE_OF_13_HITS_AMOUNT")),
            @AttributeOverride(name = "currency", column = @Column(name = "PRICE_OF_13_HITS_CURRENCY"))
    })
    private Price priceOf13Hits;

    @Column(name = "NUM_OF_GAMES_12_HITS")
    private int numOfGames12Hits;

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "amount", column = @Column(name = "PRICE_OF_12_HITS_AMOUNT")),
            @AttributeOverride(name = "currency", column = @Column(name = "PRICE_OF_12_HITS_CURRENCY"))
    })
    private Price priceOf12Hits;

    @Column(name = "NUM_OF_GAMES_11_HITS")
    private int numOfGames11Hits;

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "amount", column = @Column(name = "PRICE_OF_11_HITS_AMOUNT")),
            @AttributeOverride(name = "currency", column = @Column(name = "PRICE_OF_11_HITS_CURRENCY"))
    })
    private Price priceOf11Hits;

    @Column(name = "NUM_OF_GAMES_10_HITS")
    private int numOfGames10Hits;

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "amount", column = @Column(name = "PRICE_OF_10_HITS_AMOUNT")),
            @AttributeOverride(name = "currency", column = @Column(name = "PRICE_OF_10_HITS_CURRENCY"))
    })
    ...
    Round(Long id, int year, int week, int round, LocalDate date,
